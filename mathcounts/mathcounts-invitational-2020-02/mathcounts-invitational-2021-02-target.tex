...
\begin{tikzpicture}\node[textbox]{%
    \begin{minipagex}{\dimexpr\textwidth-20pt}
        ...
        \begin{center}
        \includegraphics[width=0.3\linewidth]{target-08-figure-B-1}
        \includegraphics[width=0.3\linewidth]{target-08-figure-B-2}
        \includegraphics[width=0.3\linewidth]{target-08-figure-B-3}\\
        \includegraphics[width=0.3\linewidth]{target-08-figure-B-4}
        \includegraphics[width=0.3\linewidth]{target-08-figure-B-5}
        \includegraphics[width=0.3\linewidth]{target-08-figure-B-6}\\
        \includegraphics[width=0.3\linewidth]{target-08-figure-B-7}
        \includegraphics[width=0.3\linewidth]{target-08-figure-B-8}
        \includegraphics[width=0.3\linewidth]{target-08-figure-B-9}
        \end{center}
