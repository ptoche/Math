...
\begin{tikzpicture}[thick, x=8cm, y=8cm,double arc/.style={double,double distance=2pt}]
    ...
    \draw (P) -- (W|-P) node [midway, below] {x} -- (E|-P) node [midway, below] {w}-- (Q|-P) node [midway, below] {x}; 
\end{tikzpicture}
...
\begin{tikzpicture}[thick, x=8cm, y=8cm]
    ...
    \draw [dashed,lightgray] (E) -- (xE) node [shift={(2pt,-8pt)},black] {$x_{\text{E}}$};
\end{tikzpicture}
