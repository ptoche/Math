...
\end{align*} 
\begin{center}
\includegraphics[height=6cm,page=5]{quadrilateral-area-shaded}
\end{center}
...
\end{center}
Next, we calculate the width of the quadrilateral. For clarity we add some labels and focus on the top part of the picture. 
\begin{center}
\includegraphics[height=8cm,page=4]{quadrilateral-area-shaded}
\end{center}
Let $w$ denote the length of EW and let $x$ denote the length of $\text{E}\text{E}^{\prime}$. Since the square has side length $a$, we have $w+2x=a$. Consider triangle CDQ. Because CE is on the diagonal of square ABCD, it is a bisector of DCQ, and therefore it is the diagonal of square $\text{C}\text{E}^{\prime}\text{E}\text{E}^{\prime\prime}$.
Triangles CDQ and  $\text{E}^{\prime\prime}\text{D}\text{E}$ are similar, so that the ratio of their legs are equal
\begin{align*}
\frac{\text{CD}}{\text{CQ}} = \frac{\text{E}^{\prime\prime}\text{D}}{\text{E}^{\prime\prime}\text{E}} 
\end{align*}
...
\begin{center}
\includegraphics[height=12cm,page=6]{quadrilateral-area-shaded}
\end{center}
