...
\usepackage{fancyhdr}
\pagestyle{fancy}
\graphicspath{{usamts-round-3/figures-1}{usamts-round-3/figures-2}{usamts-round-3/figures-3}{usamts-round-3/figures-4}{usamts-round-3/figures-5}}
\addbibresource{usamts-round-3/references.bib}
\begin{document}
\include{usamts}
...
\begin{question}
\input{usamts-round-3/problem-1-question}
\end{question}
\input{usamts-round-3/problem-1-solution}
\end{solution}
...
\begin{question}
\input{usamts-round-3/problem-2-question}
\end{question}
\input{usamts-round-3/problem-2-solution}
\end{solution}
...
\begin{question}
\input{usamts-round-3/problem-3-question}
\end{question}
\input{usamts-round-3/problem-3-solution}
\end{solution}
...
\begin{question}
\input{usamts-round-3/problem-4-question}
\end{question}
\input{usamts-round-3/problem-4-solution}
\end{solution}
...
\begin{question}
\input{usamts-round-3/problem-5-question}
\end{question}
\input{usamts-round-3/problem-5-solution}
\end{solution}

\input{usamts-round-3/statement}
