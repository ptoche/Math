...
print("95%% posterior interval (analytic):  %.3f, %.3f" % posterior_{i}nterval_analytic)
\end{python}
...
print("95%% posterior interval (simulation):  %.3f, %.3f" % posterior_{i}nterval_simulation)
\end{python}
...
print("95%% confidence interval (analytic):  %.3f, %.3f" % confidence_{i}nterval_analytic)
\end{python}
...
print('Estimated 90%% confidence interval:\t %.3f, %.3f' % confidence_{i}nterval)
\end{python}
...
print('Estimated 90%% confidence interval:\t %.3f, %.3f' % boot_confidence_{i}nterval)
\end{python}
