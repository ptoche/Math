\subsection{18. Loglinear Models}\label{loglinear-models}
...
\begin{figure}[H]
\includegraphics[width=0.9\linewidth,height=0.2\textheight,keepaspectratio]{Figure-18-01}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.9\linewidth,height=0.2\textheight,keepaspectratio]{Figure-18-02}
\end{figure}
...
There are many model searching strategies. A common approach is to use
...
\emph{Example}: Let \(X = (X_1, X_2)\) where \(X_1 \in \{0, 1\}\) and
...
\begin{figure}[H]
\includegraphics[width=0.9\linewidth,height=0.2\textheight,keepaspectratio]{Figure-18-03}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.9\linewidth,height=0.2\textheight,keepaspectratio]{Figure-18-04}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.9\linewidth,height=0.2\textheight,keepaspectratio]{Figure-18-05}
\end{figure}
...
\item
  \$X\_1 \text{ ⫫ } X\_4 \textbar{} X\_2, X\_3 \$
\item
  \$X\_2 \text{ ⫫ } X\_3 \textbar{} X\_1, X\_4 \$
\end{itemize}

\textbf{(c)} The model is not graphical, since \(\psi_1 = 0\) but the
...
\begin{figure}[H]
\includegraphics[width=0.9\linewidth,height=0.2\textheight,keepaspectratio]{Figure-18-06}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.9\linewidth,height=0.2\textheight,keepaspectratio]{Figure-18-07}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.9\linewidth,height=0.2\textheight,keepaspectratio]{Figure-18-08}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.9\linewidth,height=0.2\textheight,keepaspectratio]{Figure-18-09}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.9\linewidth,height=0.2\textheight,keepaspectratio]{Figure-18-10}
\end{figure}
