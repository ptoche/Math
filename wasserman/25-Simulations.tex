...
plt.plot(nn, I_lower[nn - 1], label='95% confidence lower bound', 
         color='darkred', alpha=0.5)
plt.plot(nn, I_upper[nn - 1], label='95% confidence upper bound', 
...
\]
converges to \(\EXP_f[h(X, Y)] = f_X(x_{0})\), which is our result.
